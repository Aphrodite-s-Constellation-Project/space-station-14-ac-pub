...
using Content.Server.Aphrodite.Speech.Components;
using Content.Shared.Speech;
using Robust.Shared.Random;

namespace Content.Server.Aphrodite.Speech.EntitySystems;

public sealed class AvaliAccentSystem : EntitySystem
{
